...
class mainWindow(wx.Frame):
	def __init__(self):
		super(mainWindow, self).__init__(None, title='3DK ' + version.getVersion())
		...
		self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('http://3dk.in/'), i)
		# i = helpMenu.Append(-1, _("Report a problem..."))
		# self.Bind(wx.EVT_MENU, lambda e: webbrowser.open('https://github.com/daid/Cura/issues'), i)
		i = helpMenu.Append(-1, _("Register machine complaint"))
		self.Bind(wx.EVT_MENU, self.OnMachineComplaint, i)
		helpMenu.AppendSeparator()
		i = helpMenu.Append(-1, _("About 3Dk..."))
