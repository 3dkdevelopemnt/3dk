...
class aboutWindow(wx.Frame):
	def __init__(self):
		...
		title = wx.StaticText(p, -1, '3DK')
		title.SetFont(wx.Font(18, wx.SWISS, wx.NORMAL, wx.BOLD))
		s.Add(title, flag=wx.ALIGN_CENTRE|wx.EXPAND|wx.BOTTOM, border=5)

		s.Add(wx.StaticText(p, -1, 'End solution for Open Source Fused Filament Fabrication 3D printing.'))
		s.Add(wx.StaticText(p, -1, '3DK is a modified version of Cura, which is currently developed and maintained by Ultimaker.'))

		s.Add(wx.StaticText(p, -1, '3DK is build with the following components:'), flag=wx.TOP, border=10)
